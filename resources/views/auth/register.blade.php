            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right"> Roles <span class="required"></span></label>
                            <div class="col-md-6">
                                <select name='roles' class ='form-control selectpicker selectField' placeholder='Seleccione rol' data-live-search='true' id ='roles'>
                                    <option value="" ></option>
