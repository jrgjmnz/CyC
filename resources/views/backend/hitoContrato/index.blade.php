...
@role('Admin')
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="{{ route('hitoContrato.index', $contrato) }}">Hitos</a>
        </li>
        <li class="breadcrumb-item active">Alerta Contratos</li>
    </ol>

    <!-- DataTables Example -->
    <div class="card mb-3">
        <div class="card-header">
            <form method="get" class="form-horizontal" action="{{ route('hitoContrato.index', $contrato) }}">
                {!! csrf_field() !!}
                <hr>
                <div class="btn-group float-right ml-3">
                    <a href="{{ route('hitoContrato.new', $contrato) }}" class="btn btn-primary rounded"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Nuevo</a>
                </div>
                <div class="btn-group float-right ml-3">
                    <a href="{{ route('hitoContrato.mostrarTodos', $contrato) }}" class="btn btn-warning rounded">Mostrar todos</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!$hitosItem->deleted_at) 
                                        ...
                                        @endif
                                        <a href="{{ route('hitoContrato.form', [$hitosItem->id, $contrato]) }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil-alt"></i> Editar</a>
                                        ...
                                        <div class="modal fade" id="vistoModal{{ $hitosItem->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form class="form-horizontal" method="post" action="{{ route('hitoContrato.visto', $hitosItem->id) }}" >
                                                        {!! csrf_field() !!}
                                        ...
                                        <div class="modal fade" id="recuperarVistoModal{{ $hitosItem->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form class="form-horizontal" method="post" action="{{ route('hitoContrato.recuperar', $hitosItem->id) }}" >
                                                        {!! csrf_field() !!}
                                                        <div class="modal-header">
                                        ...
                                        <!-- modal eliminar starts -->
                                        <div class="modal fade" id="deleteModal{{ $hitosItem->id }}">
                                        <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form class="form-horizontal" method="post" action="{{ route('hitoContrato.force-delete', $hitosItem->id) }}" >
                                                        {!! csrf_field() !!}
                                                        <div class="modal-header">
